...
const debug = createDebug('encode-bundle:ts-resolve');

const resolveModule = (id: string, opts: _resolve.AsyncOpts): Promise<string | null> =>
...
export const tsResolvePlugin: PluginImpl<TsResolveOptions> = ({ resolveOnly, ignore } = {}) => {
